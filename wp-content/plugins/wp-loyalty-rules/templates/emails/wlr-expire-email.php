...
?>
    ...
    <div>
        <p><?php esc_html_e( 'Redeem your hard earned reward before it expires on {wlr_expiry_date}', 'wp-loyalty-rules' ); ?></p>
        <p><a href="{wlr_expiry_redeem_url}"
              target="_blank"><?php esc_html_e( 'Shop & Redeem Now', 'wp-loyalty-rules' ); ?></a>
        </p>
